...
<template>
  <div class="feedback_add_img">
    <div v-for="(val,index) in data" :key="index" class="img_box">
      <i class="img_del iconfont icon-roundclosefill" @click="remove(index)" />
      <img :src="val">
    </div>
    <div v-if="data.length < maxLength" class="img_box">
