...
<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="limitPrice" prop="limitPrice" />

      <el-table-column label="deductPrice" prop="deductPrice" />

      <el-table-column label="quantity" prop="quantity" />

      <el-table-column label="sendQuantity" prop="sendQuantity" />

      <el-table-column label="startTime" prop="startTime">
...
import FormDialog from './components/coupon-dialog'
...
export default {
  ...
  methods: {
    async loadList() {
      this.loading = true
      const res = await this.$api.coupon.list({
        ...this.query,
        ...this.pagination
      })
    ...
    async deleteData(row) {
      const res = await this.$api.coupon.delete({ id: row.id })
      this.loadList()
